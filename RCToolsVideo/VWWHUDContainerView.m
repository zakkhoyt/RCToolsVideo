...
@interface VWWHUDContainerView () <CLLocationManagerDelegate>
...
@interface VWWHUDContainerView (CoreMotion)
-(void)startAltimeter;
-(void)stopAltimeter;
...
@end
@interface VWWHUDContainerView (CoreLocation)
...
@implementation VWWHUDContainerView
...
-(void)customizeView:(UIView*)view{
    ...
    [view.subviews enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        if([obj isKindOfClass:[VWWHUDView class]]){
            if(borders){
...
@implementation VWWHUDContainerView (CoreLocation)
...
@implementation VWWHUDContainerView (CoreMotion)
